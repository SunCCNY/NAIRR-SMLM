...
|----------:|-------------:|----------------:|---------:|
|UGIA-M     |Theoretical   |Joint frames     |5.23      |
|FSIC|Conventional |Frame by frame |15.07 |
|SMAP |Conventional |Joint frames|23.04 |
|ThunderSTORM |Conventional|Frame by frame   |32.12     |
|SIC        |Conventional  |Frame by frame   |61.34     |
|3D-DAOSTORM|Conventional  |Frame by frame   |102.35    |
|UGIA-F     |Theoretical   |Frame by frame   |172.30     |
|DECODE     |AI            |Joint frames| 201.88|
|DeepSTORM |AI |Frame by frame|895.71 |
...
### Imaging system
2D imaging, Airy point spread function (PSF), and high density (HD) of emitters. 
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_HD/Docs/Fig2DAiry_HD_Train_Frame_10.png)
...
**2DAiry_HD_Train_Frame.tif:** N data frames. 
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_HD/Docs/Fig2DAiry_HD_Test_Frame_10_Emitters.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_HD/Docs/Fig2DAiry_HD_Benchmark_UGIA-M.png)
