...
|----------:|-------------:|----------------:|---------:|
|UGIA-M     |Theoretical   |Joint frames     |6.48      |
|UGIA-F     |Theoretical   |Frame by frame   |13.26     |
...
**System:** 2D imaging, Airy point spread function (PSF), and medium density (MD) of emitters. 
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_FFL_MD/Docs/Fig2DAiry_FFL_MD_Train_Frame_10.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_FFL_MD/Docs/Fig2DAiry_FFL_MD_Train_Frame_10_Emitters.png)
...
**2DAiry_FFL_MD_Train_Frame.zip:** N data frames used as input in training of AI. The main parameters are given below.
...
**2DAiry_FFL_MD_Train_xy.zip:** N txt files each containing M emitter locations. The 2D emitter locations (x,y) in nm in each file are listed row by row, e.g.
...
The input data frame "2DAiry_FFL_MD_Train_Frame_n.tif" and the corresponding output emitter-location file "2DAiry_FFL_MD_Train_xy_n.txt" have the same frame index n. 

### Movie datatsets
Datasets are also concisely stored as an entire data movie of all frames as below.  

**2DAiry_FFL_MD_Train_Frame.tif:** N data frames. 

**2DAiry_FFL_MD_Train_xy.csv:** all activated emitter locations. 
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_FFL_MD/Docs/Fig2DAiry_FFL_MD_Test_Frame_10.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_FFL_MD/Docs/Fig2DAiry_FFL_MD_Test_Frame_10_Emitters.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_FFL_MD/Docs/Fig2DAiry_FFL_MD_Benchmark_Frame_10.png)

The emitter locations of white dots on the helix and the activated emitters of red dots over the 10th frame is shown below. 

![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_FFL_MD/Docs/Fig2DAiry_FFL_MD_Benchmark_Frame_10_Emitters.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_FFL_MD/Docs/Fig2DAiry_FFL_MD_Benchmark_UGIA-F.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_FFL_MD/Docs/Fig2DAiry_FFL_MD_Benchmark_UGIA-M.png)
...
**2DAiry_FFL_MD_xy_algorithmName.txt** 
