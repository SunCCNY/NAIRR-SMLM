...
|----------:|-------------:|----------------:|---------:|
|UGIA-M     |Theoretical   |Joint frames     |4.70      |
|UGIA-F     |Theoretical   |Frame by frame   |14.67     |
|ThunderSTORM |Conventional |Frame by frame|31.53 |
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_FFL_HD/Docs/Fig2DAiry_FFL_HD_Train_Frame_10.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_FFL_HD/Docs/Fig2DAiry_FFL_HD_Train_Frame_10_Emitters.png)
...
**2DAiry_FFL_HD_Train_Frame.zip:** N data frames used as input in training of AI. The main parameters are given below.
...
|Emitter density |D = 8|emitters/um^2| 
...
**2DAiry_FFL_HD_Train_xy.zip:** N txt files each containing M emitter locations. The 2D emitter locations (x,y) in nm in each file are listed row by row, e.g.
...
**2DAiry_FFL_HD_Train_xy.csv:** All activated emitter locations. 
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_FFL_HD/Docs/Fig2DAiry_FFL_HD_Benchmark_Frame_10.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_FFL_HD/Docs/Fig2DAiry_FFL_HD_Benchmark_Frame_10_Emitters.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_FFL_HD/Docs/Fig2DAiry_FFL_HD_Benchmark_UGIA-F.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_FFL_HD/Docs/Fig2DAiry_FFL_HD_Benchmark_UGIA-M.png)
...
**2DAiry_FFL_HD_xy_algorithmName.txt** 
