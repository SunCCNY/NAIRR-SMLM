...
|----------:|-------------:|----------------:|---------:|
|UGIA-M     |Theoretical   |Joint frames     |1.88      |
|UGIA-F     |Theoretical   |Frame by frame   |8.45      |
|DECODE     |AI            |Joint frames|16.49 |
|FSIC|Conventional |Frame by frame |20.05 |
|DeepSTORM |AI |Frame by frame|21.97 |
|ThunderSTORM |Conventional |Frame by frame  |25.79     |
|SMAP |Conventional |Joint frames|29.26 |
|SIC        |Conventional  |Frame by frame   |51.23     |
|3D-DAOSTORM|Conventional  |Frame by frame   |104.03    |
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_LD/Docs/Fig2DAiry_LD_Train_Frame_10.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_LD/Docs/Fig2DAiry_LD_Train_Frame_10_Emitters.png)
...
**2DAiry_LD_Train_Frame.zip:** The data movie of N frames used as input in training of AI. 

The 10th frame with the activated emitters are shown above. 

**2DAiry_LD_Train_xy.zip:** N txt files each containing the list of activated emitter locations of 2D coordinates (x,y) in nm in the row-by-row format, e.g.
...
The input data frame "2DAiry_LD_Train_Frame_n.tif" and the corresponding output emitter-location file "2DAiry_LD_Train_xy_n.txt" have the same frame index n. 

### Movie datatsets
Datasets are also concisely stored as an entire data movie of all frames as below.  

**2DAiry_LD_Train_Frame.tif:** N data frames. 

**2DAiry_LD_Train_xy.csv:** All activated emitter locations. 
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_LD/Docs/Fig2DAiry_LD_Train_xy.png)
...
|Field of view (FOV) |[0, Lx] x [0, Ly] = [0, 6400] x [0, 6400]|nm^2| 
|Pixel size |Dx = 100, Dy = 100 | nm |
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_LD/Docs/Fig2DAiry_LD_Test_Frame_10.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_LD/Docs/Fig2DAiry_LD_Test_Frame_10_Emitters.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_LD/Docs/Fig2DAiry_LD_Benchmark_Frame_10.png)

The emitter locations of white dots on the helix and the activated emitters of red dots over the 10th frame is shown below. 

![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_LD/Docs/Fig2DAiry_LD_Benchmark_Frame_10_Emitters.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_LD/Docs/Fig2DAiry_LD_Benchmark_UGIA-F.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_LD/Docs/Fig2DAiry_LD_Benchmark_UGIA-M.png)
...
**2DAiry_LD_xy_algorithmName.txt** 
