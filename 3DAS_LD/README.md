...
|UGIA-F     |Theoretical   |Frame by frame   |25.97     |
|DECODE     |AI            |Joint frames|32.49 |
|ThunderSTORM |Conventional |Frame by frame|60.36 |
|3D-DAOSTORM|Conventional|Frame by frame|76.12 |
|QC-STORM|Conventional|Frame by frame|912.43 |
...
### Imaging system
3D imaging, astigmatic (AS) point spread function (PSF), and low density (LD) of emitters. 
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/3DAS_LD/Docs/Fig3DAS_LD_Train_Frame_10.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/3DAS_LD/Docs/Fig3DAS_LD_Train_Frame_10_Emitters.png)
...
**3DAS_LD_Train_Frame.zip:** The data movie of N frames used as input in training of AI. 

The 10th frame with the activated emitters are shown above. 

**3DAS_LD_Train_xy.zip:** N txt files each containing the list of activated emitter locations of 3D coordinates (x,y,z) in nm in the row-by-row format, e.g.
...
The input data frame "3DAS_LD_Train_Frame_n.tif" and the corresponding output emitter-location file "3DAS_LD_Train_xyz_n.txt" have the same frame index n. 

### Movie datatsets
Datasets are also concisely stored as an entire data movie of all frames as below.  

**3DAS_LD_Train_Frame.tif:** N data frames. 

**3DAS_LD_Train_xy.csv:** All activated emitter locations. 
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/3DAS_LD/Docs/Fig3DAS_LD_Train_xy.png)
...
|Parameter |Variable and value| Unit| 
|:-----|:-----|:-----| 
|Number of emitters |M = 320 |Ground-truth emitters | 
|Emitter density on camera plane |D = 31.25|emitters/um^2| 
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/3DAS_LD/Docs/Fig3DAS_LD_Test_xyz.png)

The 10th frame is shown below.

![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/3DAS_LD/Docs/Fig3DAS_LD_Test_Frame_10.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/3DAS_LD/Docs/Fig3DAS_LD_Test_Frame_10_Emitters.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/3DAS_LD/Docs/Fig3DAS_LD_Benchmark_xyz.png)

The 10th frame is shown below.

![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/3DAS_LD/Docs/Fig3DAS_LD_Benchmark_Frame_10.png)

The emitter locations of white dots on the helix and the activated emitters of red dots over the 10th frame is shown below. 

![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/3DAS_LD/Docs/Fig3DAS_LD_Benchmark_Frame_10_Emitters.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/3DAS_LD/Docs/Fig3DAS_LD_Benchmark_xyz_UGIA-F.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/3DAS_LD/Docs/Fig3DAS_LD_Benchmark_xyz_UGIA-M.png)
