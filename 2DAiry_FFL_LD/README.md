...
|----------:|-------------:|----------------:|---------:|
|UGIA-M     |Theoretical   |Joint frames     |4.95      |
|UGIA-F     |Theoretical   |Frame by frame   |9.21     |
|ThunderSTORM |Conventional |Frame by frame  |13.73 |
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_FFL_LD/Docs/Fig2DAiry_FFL_LD_Train_Frame_10.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_FFL_LD/Docs/Fig2DAiry_FFL_LD_Train_Frame_10_Emitters.png)
...
**2DAiry_FFL_LD_Train_Frame.zip:** N data frames used as input in training of AI. The main parameters are given below.
...
**2DAiry_FFL_LD_Train_xy.zip:** N txt files each containing M emitter locations. The 2D emitter locations (x,y) in nm in each file are listed row by row, e.g.
...
The input data frame "2DAiry_FFL_LD_Train_Frame_n.tif" and the corresponding output emitter-location file "2DAiry_FFL_LD_Train_xy_n.txt" have the same frame index n. 
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_FFL_LD/Docs/Fig2DAiry_FFL_LD_Test_Frame_10.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_FFL_LD/Docs/Fig2DAiry_FFL_LD_Test_Frame_10_Emitters.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_FFL_LD/Docs/Fig2DAiry_FFL_LD_Benchmark_Frame_10.png)

The emitter locations of white dots on the helix and the activated emitters of red dots over the 10th frame is shown below. 

![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_FFL_LD/Docs/Fig2DAiry_FFL_LD_Benchmark_Frame_10_Emitters.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_FFL_LD/Docs/Fig2DAiry_FFL_LD_Benchmark_UGIA-F.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_FFL_LD/Docs/Fig2DAiry_FFL_LD_Benchmark_UGIA-M.png)
...
**2DAiry_FFL_LD_xy_algorithmName.txt** 
