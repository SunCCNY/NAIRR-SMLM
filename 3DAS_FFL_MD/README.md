...
|----------:|-------------:|----------------:|---------:|
|UGIA-M     |Theoretical   |Joint frames      |25.39    |
|UGIA-F     |Theoretical   |Frame by frame   |41.99     |
...
**System:** 3D imaging, astigmatic point spread function (PSF), and medium density (MD) of emitters. 
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/3DAS_FFL_MD/Docs/Fig3DAS_FFL_MD_Train_Frame_10.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/3DAS_FFL_MD/Docs/Fig3DAS_FFL_MD_Train_Frame_10_Emitters.png)
...
**3DAS_FFL_MD_Train_Frame.zip:** N data frames used as input in training of AI. The main parameters are given below.
...
|Number of emitters |M = 25 |emitters/frame | 
|Emitter density on camera plane |D = 2.5|emitters/um^2| 
...
**3DAS_FFL_MD_Train_xy.zip:** N txt files each containing M emitter locations. The 3D emitter locations (x,y,z) in nm in each file are listed row by row, e.g.
...
The input data frame "3DAS_FFL_MD_Train_Frame_n.tif" and the corresponding output emitter-location file "3DAS_FFL_MD_Train_xyz_n.txt" have the same frame index n. 

### Movie datatsets
Datasets are also concisely stored as an entire data movie of all frames as below.  

**3DAS_FFL_MD_Train_Frame.tif:** N data frames. 

**3DAS_FFL_MD_Train_xy.csv:** All activated emitter locations. 
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/3DAS_FFL_MD/Docs/Fig3DAS_FFL_MD_Test_xyz.png)

The 10th frame is shown below.

![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/3DAS_FFL_MD/Docs/Fig3DAS_FFL_MD_Test_Frame_10.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/3DAS_FFL_MD/Docs/Fig3DAS_FFL_MD_Test_Frame_10_Emitters.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/3DAS_FFL_MD/Docs/Fig3DAS_FFL_MD_Benchmark_xyz.png)

The 10th frame is shown below.

![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/3DAS_FFL_MD/Docs/Fig3DAS_FFL_MD_Benchmark_Frame_10.png)

The emitter locations of white dots on the helix and the activated emitters of red dots over the 10th frame is shown below. 

![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/3DAS_FFL_MD/Docs/Fig3DAS_FFL_MD_Benchmark_Frame_10_Emitters.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/3DAS_FFL_MD/Docs/Fig3DAS_FFL_MD_Benchmark_xyz_UGIA-F.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/3DAS_FFL_MD/Docs/Fig3DAS_FFL_MD_Benchmark_xyz_UGIA-M.png)
...
**3DAS_FFL_MD_xyz_algorithmName.txt** 
