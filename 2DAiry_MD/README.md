...
|----------:|-------------:|----------------:|---------:|
|UGIA-M     |Theoretical   |Joint frames     |3.05      |
|UGIA-F     |Theoretical   |Frame by frame   |12.16     |
|SMAP |Conventional |Joint frames|17.07 |
|FSIC|Conventional |Frame by frame |18.47 |
|ThunderSTORM |Conventional |Frame by frame|19.40 | 
|SIC        |Conventional   |Frame by frame |54.23 |
|DECODE     |AI            |Joint frames| 62.67|
|3D-DAOSTORM|Conventional  |Frame by frame   |69.78   |
|DeepSTORM |AI |Frame by frame|74.70 |
...
### Imaging system
2D imaging, Airy point spread function (PSF), and medium density (MD) of emitters. 
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_MD/Docs/Fig2DAiry_MD_Train_Frame_10.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_MD/Docs/Fig2DAiry_MD_Train_Frame_10_Emitters.png)
...
**2DAiry_MD_Train_xy.zip:** N txt files each containing the list of activated emitter locations of 2D coordinates (x,y) in nm in the row-by-row format, e.g.
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_MD/Docs/Fig2DAiry_MD_Train_xy.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_MD/Docs/Fig2DAiry_MD_Test_Frame_10.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_MD/Docs/Fig2DAiry_MD_Test_Frame_10_Emitters.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_MD/Docs/Fig2DAiry_MD_Benchmark_Frame_10.png)

The emitter locations of white dots on the helix and the activated emitters of red dots over the 10th frame is shown below. 

![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_MD/Docs/Fig2DAiry_MD_Benchmark_Frame_10_Emitters.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_MD/Docs/Fig2DAiry_MD_Benchmark_UGIA-F.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DAiry_MD/Docs/Fig2DAiry_MD_Benchmark_UGIA-M.png)
...
**2DAiry_MD_xy_algorithmName.txt** 
