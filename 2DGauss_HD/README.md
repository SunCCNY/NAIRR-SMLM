...
| Algorithm |Algorithm Type | Localization Type | RMSMD-F (nm)|
|----------:|-------------:|----------------:|---------:|
|UGIA-M     |Theoretical   |Joint frames     |7.04      |
|FSIC|Conventional |Frame by frame |7.85 | 
|ThunderSTORM |Conventional |Frame by frame  |7.93 |
|SIC|Conventional |Frame by frame | 58.29|
|3D-DAOSTORM|Conventional|Frame by frame|122.69 |
|DECODE     |AI            |Joint frames|146.55 |
|UGIA-F     |Theoretical   |Frame by frame   |152.80     |
|DeepSTORM |AI |Frame by frame|666.96 |
...
### Imaging system
2D imaging, Gaussian point spread function (PSF), and high density (HD) of emitters. 
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DGauss_HD/Docs/Fig2DGauss_HD_Train_Frame_10.png)
...
**2DGauss_HD_Train_Frame.tif:** N data frames. 

**2DGauss_HD_Train_xy.csv:** All activated emitter locations. 
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DGauss_HD/Docs/Fig2DGauss_HD_Test_Frame_10_Emitters.png)
...
![Alt text](https://github.com/SunCCNY/NAIRR-SMLM/blob/main/2DGauss_HD/Docs/Fig2DGauss_HD_Benchmark_UGIA-M.png)
