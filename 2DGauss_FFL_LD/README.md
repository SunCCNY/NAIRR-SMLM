...
**Input:** A data frame consisting of PSFs for activated emitters through light diffraction. The data frames are generated by using the universal model of data frames in [5] [6]. The emitter activation processes in testing and benchmarking are modeled by the Markov chain in [7]-[8]. All paramters are defined in [5]-[10]. 
...
The emitters are independely activated frame by frame following a model of Markov chain [8]. 
...
|Mean deactivation time | t_0 = 0.90 | sec |
|Mean activation time | t_1 = 0.04 | sec |
